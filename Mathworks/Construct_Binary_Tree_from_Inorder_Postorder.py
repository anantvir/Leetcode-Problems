...
When the last element is popped from the postorder array, we find the index of that element in the preorder array. The index we
get from the preorder array splits the inorder array into left and right subtree. Because elements to the left of that index
